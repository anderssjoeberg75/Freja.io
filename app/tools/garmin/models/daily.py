...
class DailyStats(BaseGarminModel):
...
class DailySummary(BaseGarminModel):
    ...
    def from_garmin_response(cls, data: dict[str, Any]) -> "DailySummary":
        ...
        # Handle timestamps which might be None
        start_ts = data.get("startTimestampGMT")
        end_ts = data.get("endTimestampGMT")
