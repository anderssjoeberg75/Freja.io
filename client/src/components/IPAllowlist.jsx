...
const IPAllowlist = () => {
    ...
    const fetchSettings = async () => {
        try {
            ...
            setStatus({ type: 'error', message: 'Could not fetch settings.' });
        } finally {
            setLoading(false);
        }
    };
    ...
    const handleSave = async () => {
        ...
        try {
            ...
            const data = await resp.json();
            if (data.success) {
                setStatus({ type: 'success', message: 'IP list saved!' });
        ...
        <div className="space-y-6 max-w-2xl mx-auto p-4 animate-in fade-in slide-in-from-bottom-4 duration-500">
            <header className="flex items-center gap-3 border-b border-mainframe-border pb-4 mb-6">
                ...
                <div>
                    ...
                    <p className="text-zinc-500 text-sm">Management of allowed IP addresses</p>
                </div>
            </header>
            ...
            <div className="bg-mainframe-card border border-mainframe-border rounded-xl p-6 shadow-2xl relative overflow-hidden">
                ...
                <div className="space-y-4 relative z-10">
                    ...
                    <textarea
                        ...
                        placeholder="e.g. 192.168.1.10, 85.226.12.3"
                    ...
                    <div className="bg-blue-900/20 border border-blue-800/50 rounded-lg p-4 flex gap-3">
                        ...
                        <div className="text-sm text-blue-200/80 leading-relaxed">
                            ...
                            <ul className="list-disc list-inside space-y-1">
                                <li>Leave empty to allow access from all network addresses.</li>
                                <li><strong>Localhost (127.0.0.1)</strong> is always allowed automatically.</li>
                                <li>Use comma (,) to separate multiple addresses.</li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <div className="bg-amber-900/20 border border-amber-800/50 rounded-lg p-4 flex gap-3">
                        ...
                        <p className="text-sm text-amber-200/80">
                            <strong>Warning:</strong> If you enter incorrect IP addresses, you might lock yourself out of the web interface. Make sure your current IP is included in the list.
                        </p>
                    </div>
